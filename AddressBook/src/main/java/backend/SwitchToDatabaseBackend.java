...
public class SwitchToDatabaseBackend extends Menu {
	BackendManagerMenu bm;
	private Scanner scanner;
	ArrayList<Backend> list;
	
	public SwitchToDatabaseBackend(int id, String name, BackendManagerMenu menu) {
		super(id, name);
	...
	public void doSelected() {
		checkInstance();
		setCurrentBackend();
		bm.setBackendhelper(new DatabaseAddressBookHelper(bm));
		System.out.println("\nBackend Helper: " + bm.getBackendhelper()+ "\n");
		super.doSelected();
	}
